...
OWNER_NAME = getenv("OWNER_NAME", "ll_SABKA_BHAI_KILLER_ll")
ALIVE_NAME = getenv("ALIVE_NAME", "Shiv-Music")
...
ALIVE_IMG = getenv("ALIVE_IMG", "https://telegra.ph/file/c4c74ca853dbe426b5075.jpg")
